...
<div class="topnav">
  ...
  <tr>
    <td height="100%" bgcolor="#ffffff"><table width="100%" height="100%" cellpadding="0" cellSpacing=0 border=0 borderColor="#ff0000">
        <tbody>
          <tr>
            <td noWrap id="frmTitle" bgcolor="#ff0000" width="213" height="100%" valign="top"><IFRAME frameBorder="0" id="left" name="left" scrolling="auto" src="<?php echo U('System/menu');?>" style="VISIBILITY:inherit;width:200px;Z-INDEX:2; height:550px;" allowtransparency="true"></IFRAME></td>
            <td></td>
            <td width="100%"><table height="100%" cellSpacing=0 cellPadding=0 width="100%" align="right" border=0>
                <tbody>
                  <tr>
                    <td align=right><IFRAME id="main" name="main" style="width: 100%; HEIGHT: 550px" src="<?php echo U('System/main');?>" frameBorder=0></IFRAME></td>
                  </tr>
                </tbody>
              </table></td>
          </tr>
  ...
  <tr>
    <td>
		<div id="footer">
			<p class="copy"> Copyright &copy; 2014 微乾隆™(WQLCms)版权所有</p>
		</div>
	</td>
  </tr>
</table>
