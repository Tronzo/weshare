...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 ...
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="site_name" value="<?php echo C('site_name');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：微乾隆™</span>
	 ...
	 <tr> 
      ...
      <td><input type="text" name="site_url" value="<?php echo C('site_url');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://baidu.com</span>

    </tr>
     <tr> 

      <td  height="48" align="right"><strong>官方论坛地址：</strong></td>

      <td><input type="text" name="lt_url" value="<?php echo C('lt_url');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:http://baidu.com</span>

    </tr>
    <tr> 

      <td  height="48" align="right"><strong>登入页背景：</strong></td>

      <td><input id="drbj" type="text" name="drbg" value="<?php echo C('drbg');?>" class="ipt" size="45" /><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('drbj',1000,500,'<?php echo ($token); ?>')" class="btnGreens">上传</a> <a href="###" onclick="viewImg('drbj')" class="btnGreens">预览</a><span>&nbsp;&nbsp;放置网站登入页背景图</span>

    </tr>
     <tr> 

      <td  height="48" align="right"><strong>登入页logo：</strong></td>

      <td><input id="drlg" type="text" name="drlogo" value="<?php echo C('drlogo');?>" class="ipt" size="45" /><a href="###" onclick="upyunPicUpload('drlg',1000,500,'<?php echo ($token); ?>')" class="btnGreens">上传</a> <a href="###" onclick="viewImg('drlg')" class="btnGreens">预览</a><span>&nbsp;&nbsp;放置网站登入页logo</span>
	 ...
	 <tr> 
      ...
      <td><input id="wzlg" type="text" name="site_logo" value="<?php echo (($f_logo)?($f_logo):'/tpl/Home/default/common/images/logo-wqlcms.png'); ?>" class="ipt" size="100" /><a href="###" onclick="upyunPicUpload('wzlg',1000,500,'<?php echo ($token); ?>')" class="btnGreens">上传</a> <a href="###" onclick="viewImg('wzlg')" class="btnGreens">预览</a><span>&nbsp;&nbsp;放置网站的LOGO</span>

    </tr>

	 <tr> 

      <td  height="48" align="right"><strong>网站二维码：</strong></td>

      <td><input id="ewm" type="text" name="site_qrcode" value="<?php echo (($f_qrcode)?($f_qrcode):'/tpl/Home/default/common/images/ewm.jpg'); ?>" class="ipt" size="100" /><a href="###" onclick="upyunPicUpload('ewm',1000,500,'<?php echo ($token); ?>')" class="btnGreens">上传</a> <a href="###" onclick="viewImg('ewm')" class="btnGreens">预览</a><span>&nbsp;&nbsp;放置网站的LOGO</span>
	...
	<tr> 
      ...
      <td><input type="text" name="site_my" value="<?php echo C('site_my');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:小白</span>
    ...
    <tr> 
      ...
      <td><input type="text" name="site_chatkey" value="<?php echo C('site_chatkey');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;</span>
    ...
    <tr> 
      ...
      <td><input type="text" name="server_topdomain" value="<?php echo C('server_topdomain');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;比如:a.com,b.com.cn　用于升级认证</span>
    ...
    <tr> 
      ...
      <td  height="48" align="right"><strong>一键加群链接：</strong></td>
    ...
    <tr> 
      ...
      <td><input type="text" name="site_mp" value="<?php echo C('site_mp');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:13888888888(开通短信时用于接收注册通知)</span>
	...
	<tr> 
      ...
      <td><input type="text" name="site_email" value="<?php echo C('site_email');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例如:QQ:123456@qq.com</span>
	...
	<tr> 
      ...
      <td><textarea	 type="text" name="copyright" class="ipt" style="width:450px;height:60px;margin:5px 0 5px 0;" /><?php echo C('copyright');?></textarea><span>&nbsp;&nbsp;例:wqlcms版权所有</span>
