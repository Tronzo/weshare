<?php if (!defined('THINK_PATH')) exit();?>﻿iu<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1">
<title><?php echo C('site_name');?>-WQLCms后台管理登录</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="Keywords" content="微乾隆™营销系统" />
<meta name="Description" content="微乾隆™营销系统" />
...
<script type="text/javascript">
    ...
    function refresh() {
        ...
        $("#imgCheckB").attr("src", "<?php echo U('Admin/verify');?>&rz=" + randomRZ);
    }
</script>
	...
	<div class="loginBox">
			...
			<div class="content">
            	<form name="form1" method="post" action="<?php echo U('Admin/insert');?>" id="form1" class="myform">
                	...
                	<fieldset>
                		<legend><h1>微乾隆™公众平台后台管理系统</h1></legend>
...
<div class="footer pt30">
	CopyRight &copy 2014 WQLCms All Rights Reserved 版权所有 微乾隆™管理平台<br />
