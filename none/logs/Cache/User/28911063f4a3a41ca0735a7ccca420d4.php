...
<div class="media_preview_area" id="singlenews" style="display:none"></div>
 <input type="hidden" class="px" id="imgids" value="1" name="imgids" style="width:300px" >  <br>
 <a href="###" onclick="addImgMessage()" class="btn btn-primary btn_submit  J_ajax_submit_btn">选择图文消息</a>&nbsp;&nbsp;<a style="display:none" href="###" onclick="clearMessage()" class="a_clear">清空重选</a>
