...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Greeting_card/add');?>" title="新增贺卡" class="btn btn-primary btn_submit  J_ajax_submit_btn">新增贺卡</a> </div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<?php if(is_array($greeting_card)): $i = 0; $__LIST__ = $greeting_card;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$greeting_card): $mod = ($i % 2 );++$i;?><tr>
	...
	<td class="norightborder">
		<a href='###' Onclick='javascript:demo("/index.php?g=User&m=Demo_img&a=index&id=<?php echo ($greeting_card["id"]); ?>&act=Greeting_card");' title="预览">预览</a> 
