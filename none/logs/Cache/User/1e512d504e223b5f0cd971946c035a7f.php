...
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Repast/add',array('token' => $token,'cid'=>$cid));?>" title="添加" class="btn btn-primary btn_submit  J_ajax_submit_btn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加桌台</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
