...
<div class="cLine">
<div class="pageNavigator left"> <a href="###" onclick="$('#info').submit()" title="批量删除" class="btn btn-primary btn_submit  J_ajax_submit_btn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">批量删除</a></div>
<div class="clr"></div>
</div>
