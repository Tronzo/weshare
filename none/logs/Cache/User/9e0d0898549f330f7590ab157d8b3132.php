...
<div class="content"  >
   ...
   <div class="cLineB"> 
    ...
    <a href="<?php echo U('Jikedati/index',array('token'=>$token));?>" class="right  btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-27px">返回</a> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <tbody> 
	   ...
	   <tr> 
        ...
        <td><input  type="text" id="timu" name="timu" value="<?php echo ($set["timu"]); ?>" class="px require" style="width:400px;" /></td> 
        ...
        <th ><span class="red">*</span>答案1：</th> 



        <td><input  type="text" id="answer1" name="answer1" value="<?php echo ($set["answer1"]); ?>" class="px require" style="width:400px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分数:<input  type="text" id="score1" name="score1" value="<?php echo ($set["score1"]); ?>" class="px require" style="width:50px; margin-left:20px" /></td> 
        ...
        <th ><span class="red">*</span>答案2：</th> 



        <td><input  type="text" id="answer2" name="answer2" value="<?php echo ($set["answer2"]); ?>" class="px require" style="width:400px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分数:<input  type="text" id="score2" name="score2" value="<?php echo ($set["score2"]); ?>" class="px require" style="width:50px;margin-left:20px" /></td> 
        ...
        <th ><span class="red">*</span>答案3：</th> 



        <td><input  type="text" id="answer3" name="answer3" value="<?php echo ($set["answer3"]); ?>" class="px require" style="width:400px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分数:<input  type="text" id="score3" name="score3" value="<?php echo ($set["score3"]); ?>" class="px require" style="width:50px;margin-left:20px" /></td> 
        ...
        <th ><span class="red">*</span>答案4：</th> 



        <td><input  type="text" id="answer4" name="answer4" value="<?php echo ($set["answer4"]); ?>" class="px require" style="width:400px;" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分数:<input  type="text" id="name" name="score4" value="<?php echo ($set["score4"]); ?>" class="px require" style="width:50px;margin-left:20px" /></td> 
