...
<div class="content">
          <div class="cLineB">
              <h4 class="left">当前位置：微学校 >> 食谱管理</h4><a href="<?php echo U('School/cookbook_add',array('token'=>$token,'type'=>'assess'));?>" class="right btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-2px">新增食谱</a>
              <div class="clr"></div>
          </div>

<!-- <div class="cLineC" style="line-height: 32px;"> <a href="<?php echo U('School/cookbook_add',array('token'=>$token,'type'=>'school'));?>" class="btn btn-primary btn_submit  J_ajax_submit_btn right">添加食谱</a>　 </div> -->
...
<?php if(is_array($recipe)): $i = 0; $__LIST__ = $recipe;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody><tr>
              ...
              <a href="<?php echo U('School/cookbook_add',array('id'=>$vo['id'],'type'=>$vo['type']));?>" class="btn btn-primary btn_submit  J_ajax_submit_btn">编辑</a>
              <a href="<?php echo U('School/cookbook_del',array('id'=>$vo['id'],'type'=>$vo['type']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn btn-primary btn_submit  J_ajax_submit_btn">删除</a> </td>
