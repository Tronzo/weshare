...
<?php if(($parentid != '0') and ($parentid != '')): ?><a href="<?php echo U('Product/cats',array('token'=>$token,'parentid'=>$parentCat['parentid']));?>" class="btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-27px">返回上一级</a><?php endif; ?>
</form>
</div>
<div class="clr"></div>
</div>
...
<!--tab end-->
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Product/catAdd',array('token'=>$token,'parentid'=>$parentid,'dining'=>$isDining));?>" title="新增分类" class="btn btn-primary btn_submit  J_ajax_submit_btn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">新增分类</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
