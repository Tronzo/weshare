...
<div class="cLineD"><h4 class="left">网页小游戏 <span class="red">（点击复制按钮，拷贝网址）</span></h4></div>
                <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>大家来找同</td>
                      <td><input type='text' id='textid8_text' value='http://resource.duopao.com/duopao/games/small_games/wqlcmsgame/sameclick/sameclick.htm' />
                    ...
                    <tr>
                      <td>神秘方块</td>
                      <td><input type='text' id='textid9_text' value='http://resource.duopao.com/duopao/games/small_games/wqlcmsgame/unitem/Unitem.htm' />
                    ...
                    <tr>
                      <td>梦幻农场连连看</td>
                      <td><input type='text' id='textid10_text' value='http://resource.duopao.com/duopao/games/small_games/wqlcmsgame/DreamFarmLink/DreamFarmLink.htm' />
                    ...
                    <tr>
                      <td>小怪物吃饼干</td>
                      <td><input type='text' id='textid11_text' value='http://resource.duopao.com/duopao/games/small_games/wqlcmsgame/bouffecookie/bouffecookie.htm' />
