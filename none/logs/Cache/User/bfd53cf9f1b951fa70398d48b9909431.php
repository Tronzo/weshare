...
<div class="content">
          ...
          <div class="cLineB">
              <h4 class="left">当前位置：微学校 >> 教师管理</h4><a href="<?php echo U('School/assess_add',array('token'=>$token,'type'=>'assess'));?>" class="right btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-2px">新增教师</a>
              <div class="clr"></div>
          </div>
          <div class="cLineD">
...
<!--
                 ...
                 <TD> </TD> -->
                 <TD>
<a class="btn btn-primary btn_submit  J_ajax_submit_btn" href="<?php echo U('School/assess_add',array('token'=>$token,'tid'=>$list['tid'],'type'=>'edit'));?>"><font color="red">编辑</font></a>
<a class="btn btn-primary btn_submit  J_ajax_submit_btn" href="<?php echo U('School/del_item',array('token'=>$list['token'],'id'=>$list['tid'],'deltype'=>'assess'));?>" onclick="return(confirm('确定要删除吗？'))"  title="删除"><font color="#CCC7C7">删除</font></a>
<a class="btn btn-primary btn_submit  J_ajax_submit_btn" href="<?php echo U('School/assess_course',array('token'=>$token,'tid'=>$list['tid']));?>">添加课程</a>
                 </TD>
