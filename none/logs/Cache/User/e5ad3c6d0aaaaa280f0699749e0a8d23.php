...
<div class="content" style="width:920px; background:none;   border:none; margin-bottom:30px;" >
          <div class="cLineB"><h4>添加商户</h4><a href="javascript:history.go(-1);" class="right btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-27px">返回</a>
		  <br/>
			  <div class="tab">
          ...
          <form method="post" action="">
            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <tbody>			  
				...
				<th>图文消息简介 ：</th>
				<td>
					 <textarea name="font_summary" style="width:60%;height:200px;border:1px solid;" ></textarea>
				</td>
				</tr>
	
				<tr>
				<th>外链地址：</th>
				<td><input type="text" class="px" id="url" value="" name="url"> 
          ...
          <div class="msgWrap form" id="aa_2" style="display:none;" >
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
			  ...
			  <tr>
				...
				<tr>
				<th>logo：</th>
				<td><input type="text" id="pic2" name="logo" value="" class="px" style="width:400px;" readonly/><script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('pic2',700,420,'<?php echo ($token); ?>')" class="btn btn-primary btn_submit  J_ajax_submit_btn">上传</a> <a href="###" onclick="viewImg('pic2')" class="btn btn-primary btn_submit  J_ajax_submit_btn">预览</a></td>
				</tr>

				<tr>
				<th>显示顺序：</th>
				<td><input type="text"  name="displayorder" value="" class="px" style="width:50px;"/>
				</td>
				</tr>	
				
				 <tr>
				<th>商家详细地址：</th>
				<td><input type="text"  name="addr" value="" class="px" style="width:400px;"/>
				</td>
				</tr>

				 <tr>
				<th>联系方式：</th>
				<td><input type="text"  name="tel" value="" class="px" style="width:400px;"/>
				</td>
				</tr>
				 ...
				 <tr>
				<th>地图导航：</th>
				<td><input type="text"  name="map" value="" class="px" style="width:400px;"/>
				</td>
				</tr>
	...
	<input  name="style" type="text" id="selecttpl" class="px" value="" disabled size="40"  />
	...
	<input type="hidden" class="px" id="tpid" value="<?php echo ($info["tpid"]); ?>" name="tpid" style="width:250px">
				...
				<th>档期 ：</th>
				<td>
					 <textarea name="schedule" style="width:60%;height:100px;border:1px solid;" ></textarea>
				</td>
				</tr>
				...
				<th>商户介绍 ：</th>
				<td>
					 <textarea name="description" style="width:60%;height:200px;border:1px solid;" ></textarea>
				</td>
				</tr>	
				 </tbody>
				</table>
