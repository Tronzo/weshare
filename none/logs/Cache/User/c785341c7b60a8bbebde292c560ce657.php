...
<div class="tab">
<ul>
<li class="tabli" id="tab2"><a href="<?php echo U('Jikedati/index');?>">题目管理</a></li>
<li class="current  tabli" id="tab20"><a href="<?php echo U('Jikedati/reply');?>">回复信息配置</a></li>
</ul>
</div>
<!--tab end-->        
		...
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
             <tr>
				  ...
				  <td><span class="red">极客答题王</span>————微信里输入关键字"答题王"即可看到效果
					</td>
				</tr>
            <tr>
...
<a href="###" onclick="viewImg('picurl1')" class="btn btn-primary btn_submit  J_ajax_submit_btn">预览</a>
                ...
                <tr>
					<th>答题界面顶部图片：</th>
					<td><input type="text" id="banner" value="<?php echo ($info["banner"]); ?>" name="banner" class="px" style="width:550px;">  
<script src="/tpl/static/upyun.js"></script>
<a href="javascript:void(0)" onclick="upyunPicUpload('banner',700,420,'<?php echo ($token); ?>')" class="btn btn-primary btn_submit  J_ajax_submit_btn">上传</a>
<a href="###" onclick="viewImg('banner')" class="btn btn-primary btn_submit  J_ajax_submit_btn">预览</a>
					</td>
				</tr>
               ...
               <tr>
                 ...
                 <tr>
				  <th valign="top"><span class="red">*</span>分数名称：</th>
				  <td><input type="text" name="scorename" placeholder="结束后显示为'xxxx'指数" value="<?php echo ($info["scorename"]); ?>" class="px" style="width:550px;">
					</td>
				</tr>
                <tr>
				  <th valign="top"><span class="red">*</span>0-60分提示语：</th>
				  <td><input type="text" name="tip1"  value="<?php echo ($info["tip1"]); ?>" class="px" style="width:550px;">
					</td>
				</tr>
                <tr>
				  <th valign="top"><span class="red">*</span>60-90分提示语：</th>
				  <td><input type="text" name="tip2"  value="<?php echo ($info["tip2"]); ?>" class="px" style="width:550px;">
					</td>
				</tr>
                <tr>
				  <th valign="top"><span class="red">*</span>90-100分提示语：</th>
				  <td><input type="text" name="tip3"  value="<?php echo ($info["tip3"]); ?>" class="px" style="width:550px;">
					</td>
				</tr>
				<th>&nbsp;</th>
					<td>
