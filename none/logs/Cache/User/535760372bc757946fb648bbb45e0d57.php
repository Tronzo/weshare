...
<script src="/tpl/static/artDialog/plugins/iframeTools.js"></script>
  <div class="content"> 
   <div class="cLineB"> 
    ...
    <a href="<?php echo U('Store/norms',array('token'=>$token,'catid'=>$catid, 'type' => $type));?>" class="right  btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-27px">返回</a> 
   </div> 
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <?php if($type == 1): ?><tr> 
       ...
       <button type="submit" name="button" class="btn btn-primary btn_submit  J_ajax_submit_btn">保存</button> &nbsp; <a href="<?php echo U('Store/norms',array('token' => $token, 'catid' => $catid, 'type' => $type));?>" class="btn">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
