...
<title>微信公众平台源码,微信机器人源码,微信自动回复源码 微乾隆™多用户微信营销系统</title>
...
ul.modules li{padding:2px 2px;margin:4px;background:#efefef;float:left;width:163px}
ul.modules li div.mleft{float:left;width:60%}
ul.modules li div.mright{float:right;width:40%;text-align:right;}
</style>
</head>
