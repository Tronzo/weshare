...
<div class="content" style="width:920px; background:none;   border:none; margin-bottom:30px;" >
          <div class="cLineB"><h4>添加活动</h4><a href="javascript:history.go(-1);" class="right btn btn-primary btn_submit  J_ajax_submit_btn" style="margin-top:-27px">返回</a>
		  </div>
          <form method="post" action="">
            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <tbody>			  
				...
				<th>有效期：</th>
				<td>
					<input type="text" class="px" id="starttime" value="" onClick="WdatePicker()" name="starttime"> （含）到 
					<input type="text" class="px" id="endtime" name="endtime" value="" onClick="WdatePicker()">（含）
				</td>
				</tr>
				...
				<tr>
				<th>内容 ：</th>
				<td><textarea name="summary" id="summary" rows="5" style="width: 410px; height: 250px; border:1px solid #ccc ;">   </textarea>
				</td>
				</tr>
