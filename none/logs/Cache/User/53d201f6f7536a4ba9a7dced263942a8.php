          ...
          <form method="post" action="">
            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <tbody>			  
			    <tr>
				<th>标题：</th>
				<td><input type="text" class="px"  name="title" value="<?php echo ($vo["title"]); ?>" style="width:200px;"> </td>
				</tr>
				
				 <tr>
				<th>广告图片:</th>
				<td><input type="text" id="pic" name="img" value="<?php echo ($vo["img"]); ?>" class="px" style="width:400px;" readonly/><script src="/tpl/static/upyun.js?<?php echo date('YmdHis',time());?>"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="btn btn-primary btn_submit  J_ajax_submit_btn">上传</a> <a href="###" onclick="viewImg('pic')" class="btn btn-primary btn_submit  J_ajax_submit_btn">预览</a>
				</td>
				</tr>				
	
				<tr>
				<th>广告链接：</th>
				<td><input type="text"  name="url" value="<?php echo ($vo["url"]); ?>" class="px" style="width:400px;"/>
				</td>
				</tr>	
