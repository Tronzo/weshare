...
<div class="left"> 
	<a href="<?php echo U('Custom/set',array('token'=>$token));?>" title="添加" class="btn btn-primary btn_submit  J_ajax_submit_btn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加自定义</a>
</div>
