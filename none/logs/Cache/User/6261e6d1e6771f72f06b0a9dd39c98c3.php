...
<UL>
  ...
  <LI><A href="<?php echo U('Yuyue/index',array('token'=>$token));?>" group="app"><IMG 
  src="<?php echo RES;?>/images/member_files/reserve.png"><BR>在线预约管理</A></LI>
  <LI><A href="<?php echo U('Diaoyan/index',array('token'=>$token));?>" group="app"><IMG 
...
<UL>
  ...
  <LI><A href="<?php echo U('Repast/index',array('token'=>$token));?>" 
  ...
  <LI><A href="<?php echo U('Hotels/index',array('token'=>$token));?>" 
  group="shop"><IMG src="<?php echo RES;?>/images/member_files/app_hotels.png"><BR>微酒店</A></LI>
  <LI><A href="<?php echo U('Medical/index',array('token'=>$token));?>" 
