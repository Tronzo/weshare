...
<div class="columntitle">修改用户</div>
   <form method="post" action="?g=Agent&m=Users&a=updateUser" id="myform">
            <table class="addTable">
            <tr>
					<td height="48" align="right"><strong>用户名：</strong></td>
					<td colspan="3" class="lt">
						<input type="text" name="username" class="validate['required'] colorblur" size="45" value="<?php echo ($info["username"]); ?>" readonly /> <span class="tdtip">用户名不能修改</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3" class="lt">
						<input type="password" name="password" class="colorblur" size="45" value=""> <span class="tdtip">不修改请留空</span>
					</td>
				</tr>
				<tr>
					<td height="48" align="right"><strong>确认密码：</strong></td>
					<td colspan="3" class="lt">
						<input type="password" name="repassword" class="colorblur" size="45"/> <span class="tdtip">不修改请留空</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="3" class="lt">
						<input type="text" name="money" class="validate['required','digit'] colorblur" size="45" value="<?php echo ($info["money"]); ?>">
					</td>
				</tr>
				<tr>
