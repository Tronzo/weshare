...
<script src="/tpl/static/jquery.cookie.js"></script>
<script src="/tpl/static/send.js"></script>
...
<li>
<!--判断写入!-->
<?php if($status['status'] == '1'): ?><table width="100%" border="0" cellspacing="0" cellpadding="0" class="kuang">
...
<td>
<input style="width: 60%;float: left;" onFocus="check2(this)"onblur="check3(this)" name="tel"  class="px" id="tel" value="<?php echo ($info["tel"]); ?>"  type="text" placeholder="请输入您的电话"><input style="height: 39px;width: 38%;" type="button" value="获取验证码" id="sendBtn" onclick="sendVerifyCode();"/></td>
...
<td>
<input onFocus="check2(this)"onblur="check3(this)" name="tel"  class="px" id="tel" value="<?php echo ($info["tel"]); ?>"  type="text" placeholder="请输入您的电话"></td>
