  ...
  <nav class="nav_for_list_ul">
    ...
    <div class="ofh">
      ...
      <ul>
			...
			<?php $__FOR_START_1989303630__=4;$__FOR_END_1989303630__=count($info);for($i=$__FOR_START_1989303630__;$i < $__FOR_END_1989303630__;$i+=1){ ?><li <?php if($i == 4): ?>class="on"<?php endif; ?>></li><?php } ?>
