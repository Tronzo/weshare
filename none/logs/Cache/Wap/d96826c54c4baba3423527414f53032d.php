  ...
  <nav class="nav_for_list_ul">
    ...
    <div class="ofh">
      ...
      <ul>
			...
			<?php $__FOR_START_1238804038__=1;$__FOR_END_1238804038__=count($info);for($i=$__FOR_START_1238804038__;$i < $__FOR_END_1238804038__;$i+=1){ ?><li <?php if($i == 4): ?>class="on"<?php endif; ?>></li><?php } ?>
