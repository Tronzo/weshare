...
<link href="<?php echo RES;?>/css/allcss/cate26_0.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<?php echo RES;?>/css/126/zepto.js"></script><link type="text/css" rel="stylesheet" href="<?php echo $staticFilePath;?>/css/touch_index.css"></head>
        ...
        <section>
            ...
            <?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hostlist): $mod = ($i % 2 );++$i;?><li>
                        ...
                        <a href="<?php if($hostlist['url'] == ''): echo U('Store/products',array('token' => $_GET['token'], 'catid' => $hostlist['id'], 'wecha_id' => $wecha_id)); else: echo (htmlspecialchars_decode($hostlist["url"])); endif; ?>">
                                ...
                                <div style="background-image:url(<?php echo ($hostlist["logourl"]); ?>);">&nbsp;</div>

                                <figcaption style="height:33px; overflow:hidden;"><?php echo ($hostlist["name"]); ?></figcaption>
