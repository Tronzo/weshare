  ...
  <nav class="nav_for_list_ul">
    ...
    <div class="ofh">
		...
		<ul>
			...
			<?php $__FOR_START_774425775__=8;$__FOR_END_774425775__=count($info);for($i=$__FOR_START_774425775__;$i < $__FOR_END_774425775__;$i+=1){ ?><li <?php if($i == 8): ?>class="on"<?php endif; ?>></li><?php } ?>
