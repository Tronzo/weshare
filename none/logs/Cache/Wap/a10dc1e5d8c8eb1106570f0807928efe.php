...
<link href="<?php echo RES;?>/css/allcss/cate32_0.css" rel="stylesheet" type="text/css" />
...
<?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hostlist): $mod = ($i % 2 );++$i;?><!-- <?php var_dump($hostlist); ?> -->
