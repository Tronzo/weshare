...
<link href="./tpl/static/tpl/182/css/cate.css" rel="stylesheet" type="text/css" />
...
<img src="./tpl/static/tpl/182/images/5_top.jpg"  height="15" class="sc" />

    

    

    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i%3 == 1): ?><div><ul><?php endif; ?>

	

			<li><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>" ><img src="<?php echo ($vo["img"]); ?>" /><p><?php echo ($vo["name"]); ?></p></a>

                       

		<?php if($i%3 == 0 || count($info) == $i): ?></ul>

			<img src="./tpl/static/tpl/182/images/5_gc.jpg" height="19"  class="gc"/>
        ...
        <img src="./tpl/static/tpl/182/images/5_bottom.jpg"  height="8" class="bottom" />
