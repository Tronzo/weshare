  ...
  <nav class="nav_for_list_ul">
    ...
    <div class="ofh">
      ...
      <ul>
			...
			<?php $__FOR_START_1543701184__=4;$__FOR_END_1543701184__=count($info);for($i=$__FOR_START_1543701184__;$i < $__FOR_END_1543701184__;$i+=1){ ?><li <?php if($i == 4): ?>class="on"<?php endif; ?>></li><?php } ?>
