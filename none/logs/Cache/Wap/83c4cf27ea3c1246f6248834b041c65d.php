...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/130/reset.css" media="all">

<script type="text/javascript" src="<?php echo RES;?>/css/130/maivl.js"></script>

<script type="text/javascript" src="<?php echo RES;?>/css/116/jQuery.js"></script>

<script type="text/javascript" src="<?php echo RES;?>/css/130/swipe.js"></script>

<script type="text/javascript" src="<?php echo RES;?>/css/130/zepto.js"></script>
...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/130/font-awesome.css" media="all">
