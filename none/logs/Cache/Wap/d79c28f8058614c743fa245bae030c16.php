  ...
  <nav class="nav_for_list_ul">
    ...
    <div class="ofh">
      ...
      <ul>
		...
		<?php $__FOR_START_1400658215__=1;$__FOR_END_1400658215__=count($info);for($i=$__FOR_START_1400658215__;$i < $__FOR_END_1400658215__;$i+=1){ ?><li <?php if($i == 1): ?>class="on"<?php endif; ?>></li><?php } ?>
