...
<ul  class="mainmenu">
	...
	<?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$hostlist): $mod = ($i % 2 );++$i;?><li><a href="<?php if($hostlist['url'] == ''): echo U('Store/products',array('token' => $_GET['token'], 'catid' => $hostlist['id'], 'wecha_id' => $wecha_id)); else: echo (htmlspecialchars_decode($hostlist["url"])); endif; ?>" ><p><span><?php echo ($hostlist["name"]); ?></span><i><?php echo ($hostlist["info"]); ?></i></p><b></b></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
