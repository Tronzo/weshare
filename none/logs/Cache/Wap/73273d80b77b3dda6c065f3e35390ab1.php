...
<?php if(is_array($company)): $i = 0; $__LIST__ = $company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$com): $mod = ($i % 2 );++$i;?><div class="box box-list">
  ...
  <div class="ft table">
      ...
      <a class="td" href="http://mo.amap.com/?q=<?php echo ($com['latitude']); ?>,<?php echo ($com['longitude']); ?>&name=<?php echo ($com['shortname']); ?>&dev=0">
...
<?php if($kefu['cy'] == '1'): ?><a href="<?php echo ($kefu["info2"]); ?>" id="CustomerChatFloat" style="position: fixed; right: 0px; top: 150px; z-index: 99999; height: 70px; width: 65px; min-width: 65px; background-image: url(/tpl/Wap/default/common/css/img/MobileChatFloat.png); background-size: 65px; background-position: 0px 0px; background-repeat: no-repeat no-repeat;"></a><?php endif; ?>
