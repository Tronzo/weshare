...
<div class="topNavBox">
<div class="topNavCenterBox"><a href="<?php echo ($f_siteUrl); ?>/index.php?act=oeminfo#">
<img width="140" height="40" src="<?php echo RES;?>/images/logo.png"></a>
<ul class="nav">
 <li ><a href="<?php echo ($f_siteUrl); ?>/index.php">首页</a></li>
      
      <li><a target="_blank" href="<?php echo U('User/Index/index');?>">管理中心</a></li>
      <li><a target="_blank" href="<?php echo ($f_ltUrl); ?>">官方论坛</a></li>
      <li ><a target="_blank" href="<?php echo U('Home/Index/help');?>">功能介绍</a></li>
 <li class="cur"><a target="_blank" title="open" href="<?php echo U('Home/Index/wifi');?>">WIFI路由</a></li>
<li class="login0"><a>了解更多</a><i class="newarrowdown"></i>
    <div class="sub-nav-none">
        <a target="_blank" title="kefu" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo ($f_kfqq); ?>&site=qq&menu=yes">在线客服</a>
        <a target="_blank" title="order" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo ($f_kfqq); ?>&site=qq&menu=yes">定制开发</a>
        <a target="_blank" title="tuoguan" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo ($f_kfqq); ?>&site=qq&menu=yes">托管运营</a>
        <a target="_blank" title="agent" href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo ($f_kfqq); ?>&site=qq&menu=yes">代理合作</a>
      
        <a target="_blank" href="<?php echo ($f_qqqun); ?>">加入QQ群</a>
    </div>
</li>
