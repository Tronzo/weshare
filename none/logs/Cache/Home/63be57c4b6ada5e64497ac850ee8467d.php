...
<style type="text/css">
.yulan {
background: url(/tpl/User/weiqianlong/common/images/adma/erweimabg.png) repeat scroll 0 0 #4E5359;
color: #666666;
...
.yulan .beizhubg{color: #B4B7BC;background: url(/tpl/User/weiqianlong/common/images/adma/erweima_bg2.png) repeat-x scroll 0 0 transparent;
    font-size: 12px;
    height: 48px;
    margin: 10px auto;
    width: 230px;text-shadow: 0 -1px 0 #111112;
line-height: 48px;display: inline-block;position: relative;}
.yulan .beizhuleft{background: url(/tpl/User/weiqianlong/common/images/adma/erweima_bg2_left.png) no-repeat scroll 0 0 transparent;
    display: block;
    float: left;
    height: 48px;
    margin-left: -26px;
    width: 26px;}
.yulan .beizhuright{ background: url(/tpl/User/weiqianlong/common/images/adma/erweima_bg2_right.png) no-repeat scroll 0 0 transparent;
    display: block;
    float: right;
    height: 48px;
    margin-right: -26px;
...
.yulan .footer {
background: url(/tpl/User/weiqianlong/common/images/adma/erweimabg.png) repeat scroll 0 0  transparent;
    color: #AAAAAA;
    margin:20px auto 0;
...
.yulan .footer p{
    background: url(/tpl/User/weiqianlong/common/images/adma/erweima_footer.png) no-repeat scroll center top transparent;
