...
<body style="background: url('<?php echo ($f_drbg); ?>') repeat;">
...
<div id="wxj-header">
  ...
  <div class="container"> <a href="<?php echo ($f_siteUrl); ?>"><img id="logo" src="<?php echo ($f_drlogo); ?>" alt="<?php echo ($f_siteName); ?>"></a>
...
$('#mark-m1').attr("src","/tpl/Home/weiqianlong/common/images/mark_"+(count%4)+".png");
