...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="alipay_name" value="<?php echo C('alipay_name');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：alipay@29w.com</span>
	  </td>
    </tr>
	 <tr> 
	...
	<tr> 
		<td  height="48" align="right"><strong>选择接口类型：</strong></td>
		<td>
			<select name="alipay_pay_method">
				<?php if(is_array($alipay)): $i = 0; $__LIST__ = $alipay;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo["id"] == $alipay_pay_method): ?>selected="selected"<?php endif; ?> ><?php echo ($vo["method"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			</select><span>&nbsp;&nbsp;默认为即时到帐
		</td>
    </tr>
