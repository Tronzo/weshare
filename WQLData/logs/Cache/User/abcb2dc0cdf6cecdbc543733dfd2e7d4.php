            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><input type="text" required name="weixin" value="" class="px" tabindex="1" size="25">　比如：wqlcms </td>
                </tr>
                  <tr >
                ...
                <tr>
                 ...
                 <tr >
                  ...
                  <td><input type="text" name="token" maxlength="30" value="<?php echo ($tokenvalue); ?>" class="px" tabindex="1" size="40">(填写你的公众号)例：wqlcmsweixin,请勿填写英文,或者其它特殊字符，不超过30字符!</td>
                </tr>
